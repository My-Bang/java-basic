...
//        System.out.println("나는 CircleCal1의 areaCircle메서드야");
//        super.areaCircle(20);
...
//    }
    ...
    public double areaCircle(double radius) {
        ...
        System.out.println("부모 버전 계산 : " + result); // 자식메소드와 부모메소드의 공동작업처리 기법
        // 부모메소드를 재사용함으로써 자식메소드의 중복 작업을 최소화 할 수 있다.
        return Math.PI * radius * radius;
    }

    // 오버라이딩(메소드의 재정의)은 부모메서드는 숨겨지고, 자식 메소드만 사용되기 때문에 부모메소드의 일부만
    // 변경되더라도 중복된 내용을 자식메소드도 가질 수 있다. 간혹 부모 메소드도 호출해서 써야할 때가 있다.
